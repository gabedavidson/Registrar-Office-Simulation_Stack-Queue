...
void RegistrarOffice::getNextStudents(){
  ...
  for (int i = 0; i < studs; ++i){
    try{
      ...
      cout << "\n";
      cout << "An error occured while reading from \"" << fp->getInfile() <<"\". Please make sure the file is formatted correctly.\nWhat(): There are fewer student times listed than indicated.\nProgram will disregard error and continue." << endl;
      fileRead = true;
      return;
    }
  }
